...
import { NewsItem,ServiceItem,SchoolExamItem,TemporaryItem } from './module';
import Modals from './ui/Modal'
import ModalBottom from './ui/ModalBottom'
import ModalTextInput from './ui/ModalTextInput'


export {Header,HttpUtils,BASE_URL,PORT_NAME,NewsItem,ServiceItem,Titles,SchoolExamItem,TemporaryItem,Modals,ModalBottom,ModalTextInput}